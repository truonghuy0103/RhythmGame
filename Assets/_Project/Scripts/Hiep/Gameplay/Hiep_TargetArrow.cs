...
public class Hiep_TargetArrow : MonoBehaviour
{
        ...
        set
        {
            ...
            if (isPress)
            {
                ...
                if (countCollider == 0)
                {
                    ...
                    Hiep_GameManager.Instance.SetAnimationBoy(index + 5);
                    // Sub HP bar for Main
    ...
    public List<Hiep_Arrow> lsArrows = new List<Hiep_Arrow>();

    private int index;

    public int countCorrect;
    public void SetCollider(Hiep_Arrow arrow)
    {
        if (arrow != null)
        {
    ...
    public void ExitCollider(Hiep_Arrow arrow)
    {
        if (arrow != null)
        {
    ...
    {
        countCorrect++;
        Hiep_GameManager.Instance.SetAnimationBoy(index, timerAnim);
    }
}
