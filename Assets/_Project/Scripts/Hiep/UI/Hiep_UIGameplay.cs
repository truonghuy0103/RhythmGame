...
public class Hiep_UIGameplay : BaseUI
{
    ...
    {
        Hiep_GameManager.Instance.gameState = GameState.Ready;
        ...
        for (int i = 0; i < lsSpriteCountdowns.Count; i++)
        {
            ...
            Hiep_SoundManager.Instance.PlaySoundFX(SoundFXIndex.One + i);
            
            yield return new WaitForSeconds(timer);
        }
        
        imgReady.gameObject.SetActive(false);
        Hiep_SoundManager.Instance.PlaySoundFX(SoundFXIndex.Go);
        
        yield return new WaitForSeconds(timer);
        Hiep_GameManager.Instance.gameState = GameState.Playing;
    ...
    public void OnButtonClickDown(int index)
    {
        ...
        Hiep_GameManager.Instance.OnButtonClickDown(index);
    }
    ...
    public void OnButtonClickUp(int index)
    {
        ...
        Hiep_GameManager.Instance.OnButtonClickUp(index);
    }
    ...
    public void SetSliderHP(float delta)
    {
        ...
        {
            // Show game Lose
            Hiep_GameManager.Instance.ShowGameLose();
        }
    }
    ...
    public void OnPauseGame_Clicked()
    {
        ...
        Hiep_SoundManager.Instance.PauseSoundBGM();
        Hiep_GameManager.Instance.gameState = GameState.PauseGame;
