...
namespace Hiep
{
	public class Hiep_UIRewardLogin : BaseUI
	{
		...
		public override void OnInit()
         ...
         public override void OnSetup(UIParam param = null)
         {
            ...
            for (int i = 0; i < lsSlotItems.Count; i++)
            {
	            ...
	            Debug.Log("login: " + Hiep_GameManager.Instance.GameSave.CurrentDay + " " 
	                      + Hiep_GameManager.Instance.GameSave.CurrentDayOfWeekLogin);
	            int currentDayLogin = Hiep_GameManager.Instance.GameSave.CurrentDayLogin;
	            int currentWeekLogin = Hiep_GameManager.Instance.GameSave.CurrentDayOfWeekLogin;
